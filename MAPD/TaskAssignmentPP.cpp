...
void TaskAssignmentPP::updateAllAssignmentHeap(Agent* updatedAgent,Task* assignedTask) {
    ...
    for (auto& handlePair : allAssignmentHandles){
        ...
        if(ta_option.only_top){
            ...
            //aggiorno la matrice H (handleTable) con il valore del nuovo assegnamento
            if (handleTable[i][updatedAgent->agent_id].node_ != NULL){
                ...
                //Simulo l'inserimento del task nel robot
                ...
                if (new_assign->current_total_delay <0) {
                    ...
                    //Aggiorno lo heap con il valore ottenuto dalla simulazione di inserimento 
            ...
            /*while (!stop){
                ...
                //Tra quanto tempo trovo il conflitto
                ...
                //Cerco l'azione che genera conflitto
